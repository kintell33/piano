  ...
  return (
    <div className={styles.container}>
      <div className={styles.blackContainer}>
        <KeyBlack
          sound={key2}
          dProp="M0.763632 1.15646L95.9642 0.00531389L104.478 334.026L28.718 334.943L0.763632 1.15646Z"
          letter={'s'}
        ></KeyBlack>
        <KeyBlack
          sound={key4}
          dProp="M89.1145 0.758435L0.137954 3.38306L2.15158 337.41L72.9584 335.321L89.1145 0.758435Z"
          letter={'d'}
        ></KeyBlack>
        <KeyBlack dProp=""></KeyBlack>
        <KeyBlack
          sound={key7}
          dProp="M7.32825 0.650887L64.8094 9.17822L46.3525 342.314L0.609471 335.529L7.32825 0.650887Z"
          letter={'g'}
        ></KeyBlack>
        <KeyBlack
          sound={key9}
          dProp="M0.577909 0.0310959L78.9777 1.90849L85.266 335.732L22.8761 334.238L0.577909 0.0310959Z"
          letter={'h'}
        ></KeyBlack>
        <KeyBlack
          sound={key11}
          dProp="M89.3699 0.605145L0.393326 3.22977L2.40695 337.257L73.2137 335.168L89.3699 0.605145Z"
          letter={'j'}
        ></KeyBlack>
        <KeyBlack dProp=""></KeyBlack>
        <KeyBlack
          sound={key14}
          dProp="M0.860112 0.496733L70.0414 4.69721L70.5937 338.465L15.5398 335.122L0.860112 0.496733Z"
          letter={'l'}
        ></KeyBlack>
        <KeyBlack
          sound={key16}
          dProp="M80.5071 371.717L0.501794 363.326L19.5456 0.380182L83.2132 7.05798L80.5071 371.717Z"
          letter={'ñ'}
        ></KeyBlack>
        <KeyBlack dProp=""></KeyBlack>
        <KeyBlack
          sound={key19}
          dProp="M81.9912 366.611L9.18404 363.402L0.49403 0.151517L58.4333 2.70475L81.9912 366.611Z"
          letter={'{'}
        ></KeyBlack>
        <KeyBlack
          sound={key21}
          dProp="M72.6693 371.33L0.153525 364.075L11.6894 0.903774L69.3969 6.67697L72.6693 371.33Z"
        ></KeyBlack>
        <KeyBlack
          sound={key23}
          dProp="M85.3533 365.637L12.8375 358.382L0.682014 17.1812L82.0808 0.983613L85.3533 365.637Z"
        ></KeyBlack>
      </div>
